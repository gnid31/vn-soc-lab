...
| ES suricata-* index | ✅ 199 docs |
| ES dvwa-apache-* index | ✅ 33 docs |
| Verify Kali attack → Suricata alerts fire | ✅ 29 alerts (ET INFO + ET SCAN) |
| Detection rules R6/R7/R8 trên Kibana | ⏳ pending user GUI work |

---

*Pha 6 hoàn tất phần infrastructure. Detection rules trên Kibana là GUI work của bạn — mỗi rule theo template `detection-rules/R1-*.md §5`. Sau khi tạo R6+, ping mình verify từ VPS query alert breakdown.*
